...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 flex flex-col p-4 bg-[#f4f2fe] border-r border-[#e5e4e7] shadow-sm">
      ...
      {/* Bottom Button */}
      <button className="mt-auto mx-2 bg-[#7c3aed] text-white py-3 px-4 rounded-xl font-bold text-sm shadow-md shadow-violet-200 hover:bg-[#6d28d9] transition-all flex items-center justify-center gap-2 cursor-pointer">
